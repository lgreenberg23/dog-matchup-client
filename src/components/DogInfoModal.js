...
class ModalScrollingExample extends React.Component {
        ...
        writeComment = (props, comment) => {
            ...
            fetch('https://react-project-api.herokuapp.com/api/v1/comments', createComment)
                .then(res => res.json())
        ...
        getComments = () => {
            fetch(`https://react-project-api.herokuapp.com/api/v1/dog/comments/${this.props.dog[0]}`)
                .then(res => res.json())
                .then(res => {
                    this.setState({
                        comments: res,
        ...
        deleteComment = (comment, dog) => {
            fetch(`https://react-project-api.herokuapp.com/api/v1/dog/comments/${dog}/${comment}`, {
                    method: 'delete'
                })
        ...
        updateComment = (comment, dog, oldText) => {
            ...
            fetch(`https://react-project-api.herokuapp.com/api/v1/dog/comments/${dog}/${oldText}`, updateComment)
                .then(res => res.json())
                .then(res => {
                    this.setState({
                        comments: res,
        ...
        render() {
            if (this.state.comment === true) {
                return ( < div > < Comment dog = { this.props.dog }
                ...
                return ( <
                    Modal trigger = { < Button onClick = { this.getComments } > More Info! < /Button>}> <
                        ...
                        p > Perfect For You! < /p> <
                        h3 > Comments: < /h3> { this.state.testing ? < Comments deleteComment = { this.deleteComment }
